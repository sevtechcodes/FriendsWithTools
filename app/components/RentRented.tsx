...
const RentRented = () => {
  ...
  useEffect(() => {
    const ownerId = '6fdec126-5b6f-484f-8b6d-8c347476222a'; // Replace with the actual ownerId
    const userId = '6fdec126-5b6f-484f-8b6d-8c347476222a'; // Replace with the actual userId
