...
const RentRented = () => {
  ...
  useEffect(() => {
    const ownerId = '1763e228-4944-4067-b504-0151e443dfd5'; // Replace with the actual ownerId
    const userId = '1763e228-4944-4067-b504-0151e443dfd5'; // Replace with the actual userId
